...
const Home = () => {
    ...
    return (
        ...
        <section className="mt-[82px]">
            <div className="flex justify-evenly flex-col px-6 lg:flex-row gap-8 max-w-[1200px] mx-auto">
                <h1 className="font-roboto max-w-[450px] leading-[58px] text-4xl sm:text-[58px]">
        ...
        <section className="mt-28 sm:mt-[208px]">
            <div className="px-6 w-full max-w-6xl mx-auto">
                <ul className="flex-wrap sm:flex-nowrap flex sm:grid grid-cols-2 grid-rows-2 gap-6">
                    <li className="w-full max-w-[588px]">
        ...
        <section className="mt-28 sm:mt-[212px]">
            <div className="px-6 w-full max-w-6xl mx-auto">
                <h2 className="font-roboto text-center text-3xl sm:text-5xl leading-8 sm:leading-[48px] pb-7">
                    The world's leading brands choose ROOM.
                </h2>
                <p className="font-roboto text-center text-[#4A4A4A]  text-lg sm:text-2xl leading-9">
        ...
        <section className="mt-28 sm:mt-[237px]">
        ...
        <section className="mt-28 sm:mt-[240px]">
            <div className="px-6 w-full max-w-[882px] mx-auto">
                <p className="text-gray_2 text-4xl sm:text-5xl font-roboto max-[882px] mx-auto">
                ...
                <p className="text-4xl sm:text-5xl font-roboto max-[882px] mx-auto pt-[25px]">
        ...
        <section className="mt-[135px]">
            <div className="flex-wrap sm:flex-nowrap px-6 w-full max-w-6xl mx-auto flex items-center justify-between gap-8 sm:gap-[90px]">
                <div className="w-full max-[671px]">
        ...
        <section className="mt-28 sm:mt-72 pb-16">
            <div className="px-6 w-full max-w-6xl mx-auto">
